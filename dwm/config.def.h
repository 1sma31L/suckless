...
static const Key keys[] = {
    ...
    /*
     ...
     &layouts[2]} }, { MODKEY,                       XK_space,  setlayout, {0}
...
static const char *volupcmd[] = {"sh", "-c", "pamixer -i 5", NULL};

static const char *voldowncmd[] = {"sh", "-c", "pamixer -d 5", NULL};
